...
const FRICTION = 0.7;                 
const TARGET_FPS = 60;                // 🔒 鎖定目標 FPS
const FRAME_TIME = 1000 / TARGET_FPS; // 每幀時間 (約 16.6ms)
...
// --- 🚀 關鍵修改：固定時間步長 (Fixed Time Step) 遊戲迴圈 ---
function gameLoop(timestamp) {
    if(gameState === "PLAYING") {
        ...
        // 只有當累積時間超過一幀 (16.6ms) 時才更新邏輯
        // 這保證了無論螢幕多快，邏輯都只跑 60次/秒
